...
public class StudenteDSA extends Studente {
    private String descrizionePatologia, nomePatologia;

    public StudenteDSA(String nome, String cognome, String matricola, int anni,
                       String descrizionePatologia, String nomePatologia) {
